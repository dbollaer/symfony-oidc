...
class OidcJwtHelper
{
     ...
     */
    public function verifyTokens(string $issuer, string $jwksUri, UnvalidatedOidcTokens $tokens, bool $verifyNonce): void
    {
     ...
     */
    public function verifyIdToken(string $issuer, string $jwksUri, UnvalidatedOidcTokens $tokens, bool $verifyNonce): void
    {
